...
//Cross Origin Resource Sharing (CORS) là một cơ chế cho phép tài nguyên từ một trang web hoặc ứng dụng web được yêu cầu từ một tên miền khác nơi mà tài nguyên đó được tải. CORS cho phép các trình duyệt web yêu cầu web từ một tên miền khác ngoài tên miền mà trang web đó được tải.
